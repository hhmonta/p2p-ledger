...
import { ResumenView } from '@/components/p2p/ResumenView'
import { Wallet, BarChart3, Landmark, ShoppingCart, Tag, ListOrdered, Building2, Shield, Download, Calculator } from 'lucide-react'
        ...
        <Tabs value={tab} onValueChange={setTab} className="w-full">
          <div className="overflow-x-auto -mx-2 px-2 pb-1 sm:overflow-visible sm:mx-0 sm:px-0 sm:pb-0">
            <TabsList className="grid w-full min-w-max sm:min-w-0 grid-cols-4 sm:grid-cols-7 mb-2 sm:mb-6 h-auto gap-1">
              <TabsTrigger value="resumen" className="flex items-center gap-1 py-1.5 sm:py-2 text-[11px] sm:text-sm px-2 sm:px-3">
